...
cdismeta <- dismeta[dismeta$disease_name %in% cdisorder, ]
cdismeta <- cdismeta[match(cdisorder, cdismeta$disease_name), ] # Sort the dataframe by external vector
cdismeta$order <- c(1:length(cdismeta$disease_name))
...
cdiscols <- dismeta[dismeta$disease_name %in% colnames(cenf2wo), ]
