...
filename_var_network <- 'pairwise_union_spearman_distance_sDVGs_network.txt'
...
positive_interactions <- compute_overlap(net_pos,microarrays_pos)
negative_interactions <- compute_overlap(net_neg,microarrays_neg)
